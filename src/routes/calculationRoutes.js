...
import { calculateFireHeadLossHandler, calculateFirePumpHandler } from "../controllers/calculations/firefightController.js";
import { calculateHeatLoadHandler, calculateVentilationHandler } from "../controllers/calculations/hvacController.js";
import { calculateDrainagePipesHandler, calculatePlumbingHeadlossHandler, calculatePlumbingPumpHandler, calculateRainwaterDropSizingHandler, calculateRWHSizingHandler, calculateWaterDemandHandler, calculateWaterSupplyPipesHandler } from "../controllers/calculations/plumbingController.js";
...
router.post("/rainwaterdropsizing",verifyToken,calculateRainwaterDropSizingHandler)
